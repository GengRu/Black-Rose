    ...
    <div class="elr-food-nav">
      ...
      <div class="elr-food-nav-select" ref="t1">
        <div class="elr-food-nav-select-name">
          <div
            class="elr-food-nav-select-name-left"
            v-for="(i, $idx) in navArr"
            :key="$idx"
            :style="{ backgroundColor: tName == i.name ? '#fff' : '' }"
      ...
      <div class="elr-food-nav-select" ref="t2">
        <div
          class="elr-food-nav-select-pai"
          @click="pai(4)"
          :style="{ color: paiNum == 4 ? '#3783c1' : '' }"
        >
          智能排序
        </div>
        <div
      ...
      <div class="elr-food-nav-select" ref="t3">
        ...
        <div class="elr-food-nav-select-btn">
          <el-checkbox v-model="checked">{{ fnArr.text }}</el-checkbox>
        </div>
        ...
        <div class="elr-food-nav-select-box">
          <el-checkbox-group v-model="checkList">
            <div
              v-for="(i, $idx) in shArr"
              :key="$idx"
              class="elr-food-nav-select-box-titles"
            >
        ...
        <div class="elr-food-cont-right">
          ...
          <div class="elr-food-cont-right-xing">
            ...
            <div class="elr-food-cont-right-xing-title" v-if="i.delivery_mode">
              <span class="elr-food-cont-right-xing-title1">{{
                i.delivery_mode.text
              }}</span>
          ...
          <div class="elr-food-cont-right-foot">
            <div class="elr-food-cont-right-foot-left">
              ￥{{ i.float_minimum_order_amount }}起送 /
...
export default {
  ...
  methods: {
    ...
    cgBtn() {
      if (this.checked != "") {
        if (this.checkList.length == 0) {
          this.axios
            .get(
              "http://elm.cangdu.org/shopping/restaurants?latitude=39.78382&longitude=116.29738&offset=0&limit=20&extras[]=activities&keyword=&restaurant_category_id=&restaurant_category_ids[]=&order_by=null&delivery_mode[]=1"
            )
            .then(data => {
              // console.log(data.data)
              this.dataArr = data.data;
          ...
          this.axios
            .get(
              "http://elm.cangdu.org/shopping/restaurants?latitude=39.78382&longitude=116.29738&offset=0&limit=20&extras[]=activities&keyword=&restaurant_category_id=&restaurant_category_ids[]=&order_by=null&delivery_mode[]=null=" +
                str2
            )
            .then(data => {
              // console.log(data.data)
    ...
    pai(a) {
      this.axios
        .get(
          "http://elm.cangdu.org/shopping/restaurants?latitude=39.78382&longitude=116.29738&offset=0&limit=20&extras[]=activities&keyword=&restaurant_category_id=&restaurant_category_ids[]=&order_by=" +
            a +
            "&delivery_mode[]=null"
        )
        .then(data => {
  ...
  created() {
    ...
    this.axios
      .get(
        "http://elm.cangdu.org/shopping/v2/restaurant/category?latitude=39.78382&longitude=116.29738"
      )
      .then(data => {
        // console.log(data.data)
    ...
    this.axios
      .get(
        "http://elm.cangdu.org/shopping/v1/restaurants/delivery_modes?latitude=39.78382&longitude=116.29738&kw="
      )
      .then(data => {
    ...
    this.axios
      .get(
        "http://elm.cangdu.org/shopping/v1/restaurants/activity_attributes?latitude=39.78382&longitude=116.29738&kw="
      )
      .then(data => {
        // console.log(data.data)
