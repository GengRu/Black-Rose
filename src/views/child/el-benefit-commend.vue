<template>
  <div class="elt-commend">
    <el_Header>
      <div slot="elw-Left">
        <span @click="$router.back()" class="el-icon-arrow-left"></span>
      </div>
      <div slot="elw-cont">
        <span class="elg-title">推荐有奖</span>
      </div>
      <div slot="elr-right"></div>
    </el_Header>
    <div class="elt-commend-cont">
      <div class="elg-titleimg">
        <img src="../../assets/activity.png" />
      </div>
      <div class="elg-firend">
        <div>
          <img
            @click="btn"
    ...
    <el_alert v-if="!showHide" @closeSure="close">
      <span slot="tipInfo">请在饿了么APP打开</span>
    </el_alert>
  </div>
</template>
...
.elg-num div:nth-child(1) {
  border-right: 0.01rem solid #ccc;
}

.elg-num div:nth-child(1) span {
  color: #ff5633;
  font-size: 0.6rem;
  font-weight: bold;
}
.elg-num div:nth-child(2) span {
  color: #666;
  font-size: 0.6rem;
  font-weight: bold;
}
