      ...
      <div class="elw-box">
        ...
        <div class="elw-content">
          ...
          <div class="elw-Cpont clearfix">
            <div class="elw-Cpole">
              <div class="elw-Cpoles" v-for="(i,$inds) in larr" :key="$inds">{{i.name}}</div>
            </div>
            <div class="elw-Cpore">
              <div class="elw-Copcfo" v-for="(a,$inda) in larr" :key="$inda">
                ...
                <div class="elw-modelsk" v-for="(s,$sn) in a.foods" :key="$sn">
                  ...
                  <div class="elw-modre clearfix">
                    ...
                    <div class="elw-MIcon" v-if="s.activity!=null"><span class="elw-Micon" >{{s.activity.image_text}}</span></div>
                    <div class="elw-Mparc" v-if="s.specfoods.length!=0">￥{{s.specfoods[0].price}} <span v-if="s.specfoods.length>=2">起</span></div>
                    <div class="elw-guige" v-if="s.specfoods.length>=2">
                        <span class="elw-Mreg">选规格</span>
                    </div>
                    <div class="elw-jiajian" v-if="s.specfoods.length<=1">
                        <span class="el-icon-remove-outline"></span><span class="elw-Mvalue">1</span><span class="el-icon-circle-plus-outline"></span>
                    </div>
                  </div>
                </div>
              </div>
...
.Bgnav{
    background: #fff;
    border-left:.06rem solid #3687e0;
}
.elw-Mname span{
    float: right;
