<template>
	<div id="confirmOrder">
		...
		<div class="confirmOrder-elr-cont2">
			<img src="https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1573480857260&di=6a5c9d48ca81dd79e38769aed5624abc&imgtype=0&src=http%3A%2F%2Fpic.pc6.com%2Fup%2F2015-10%2F14444674655340116.png">
			<p>支付宝</p>
			<el-radio v-model="radio" label="1" class="confirmOrder-elr-cont2-btn"></el-radio>
		</div>
		
		<div class="confirmOrder-elr-cont2">
			<img src="https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1573480823850&di=af327b0ae60672869af5513691a4f3fa&imgtype=jpg&src=http%3A%2F%2Fstatic.fotor.com.cn%2Fassets%2Fstickers%2Ffreelancer_lmf_0315_01%2Fc9fe1862-3583-4884-8b6e-6d53c6a34142_medium_thumb.jpg">
			<p>微信</p>
			<el-radio v-model="radio" label="2" class="confirmOrder-elr-cont2-btn"></el-radio>
		</div>
