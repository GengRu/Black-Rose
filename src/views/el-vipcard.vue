<template>
	<div id="vipcard">
		<el_Header>
			<div slot="elw-Left">
				<router-link to="/profile" class="el-icon-arrow-left"></router-link>
			</div>
			<div slot="elw-cont">
				会员中心
			</div>
		...
		<div class="elr-title">
			为账户<span>{{name}}</span>购买会员
		</div>
		
		<div class="elr-conts">
			<div class="elr-conts-title">
				<div class="elr-conts-title-l">会员特权</div>
				<router-link class="elr-conts-title-r" to="/vipcard/vipDescription">会员说明 <span class="el-icon-arrow-right"></span></router-link>

				
			</div>
			<div v-for="(i, $idx) in arr" :key="$idx" class="elr-conts-cont">
				<div class="elr-conts-cont-img"><img :src="i"></div>
				<div class="elr-conts-cont-r">
					<div class="elr-conts-cont-r-tt1">减免配送费</div>
					<div>每月减免30单，每日可减免3单，每单最高减4元</div>
					<div>蜂鸟专送专享</div>
				</div>
			</div>
		</div>
		...
		<div class="elr-conts">
			<div class="elr-conts-title">
				<div class="elr-conts-title-l">开通会员</div>
			</div>
			<div class="elr-conts-title">
				<div class="elr-conts-title-l">1个月<span class="elr-color"> ¥20</span></div>
				<router-link to="/confirmOrder" class="elr-conts-title-r-btn">购买</router-link>
			</div>
		</div>
		
		<div class="elr-conts">
			<div class="elr-conts-title">
				<div class="elr-conts-title-l">兑换会员</div>
				<router-link class="elr-conts-title-r" to="/vipcard/useCart">使用卡号卡密 <span class="el-icon-arrow-right"></span></router-link>
			</div>
		</div>
		
		<div class="elr-conts">
			<div class="elr-conts-title">
				<div class="elr-conts-title-l">购买记录</div>
				<router-link class="elr-conts-title-r" to="/vipcard/invoiceRecord">开发票 <span class="el-icon-arrow-right"></span></router-link>
			</div>
		</div>
